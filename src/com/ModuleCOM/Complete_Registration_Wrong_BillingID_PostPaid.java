...
public class Complete_Registration_Wrong_BillingID_PostPaid extends TestBase {
    ...
    public void COMPLETE_REG_WRONG_BILLING_POSTPAID() throws IOException, InterruptedException {
        test = extent.createTest("COMPLETE REGISTRATION WRONG BILLING POSTPAID");
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath(Utility.fetchLocator("AccountNumber_XPATH"))).sendKeys(Utility.fetchLocator("WrongAccountNumber_TEXT"));
        ...
        System.out.println("********************COMPLETE REGISTRATION WRONG BILLING POSTPAID TEST IS COMPLETED********************");
        driver.quit();
    }
}
