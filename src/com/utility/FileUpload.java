...
public class FileUpload {
    ...
    public void UploadAbove5MB() throws IOException, InterruptedException, AWTException {

        String fileAbsolutePath = System.getProperty("user.dir") + "\\Config\\Above5mb.jpg";
        StringSelection clipBoardPath = new StringSelection(fileAbsolutePath);
        Toolkit.getDefaultToolkit().getSystemClipboard().setContents(clipBoardPath, null);
