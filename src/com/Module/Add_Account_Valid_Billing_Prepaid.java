...
public class Add_Account_Valid_Billing_Prepaid extends TestBase {

    @Test
    public void ADD_ACCOUNT_VALID_BILLING_PREPAID() throws InterruptedException, IOException {

        test = extent.createTest("ADD ACCOUNT VALID BILLING PREPAID");
        ...
        Thread.sleep(2000);
        System.out.println("********************ADD ACCOUNT VALID BILLING PREPAID TEST IS COMPLETED********************");
        driver.quit();
    }
}
