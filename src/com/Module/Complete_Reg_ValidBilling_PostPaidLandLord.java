...
public class Complete_Reg_ValidBilling_PostPaidLandLord extends TestBase {
    ...
    public void COMPLETE_REG_VALID_BILLING_POSTPAID_LANDLORD() throws IOException, InterruptedException {
        test = extent.createTest("COMPLETE REGISTRATION VALID BILLING POST-POST PAID LANDLORD");
        ...
        System.out.println("********************COMPLETE REGISTRATION TEST VALID BILLING POSTPAID LANDLORD IS COMPLETED********************");
        driver.quit();
    }
}
